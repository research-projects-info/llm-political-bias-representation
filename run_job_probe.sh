...
export SINGULARITYENV_CONDAENV="/home/projects/userDirectory/pytorch-environment"
...
export HUGGING_FACE_HUB_TOKEN=$(cat /home/projects/userDirectory/folderToken/.hf_token)
#--token < /home/projects/userDirectory/folderToken/.hf_token > /dev/null 2>&1

# Change to project directory
cd /home/projects/userDirectory/folderProbe

# Run Python scripts
echo "Running main script..."
python ProbeClassifier.py
